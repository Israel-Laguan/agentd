...
func (s *apiStore) UpdateTaskDescription(_ context.Context, _ string, _ time.Time, description string) (*models.Task, error) {
...
func (s *apiStore) ReconcileOrphanedQueued(context.Context, time.Duration) ([]models.Task, error) {
	return nil, nil
}
...
func (s *apiStore) ListParentTasksByRelation(context.Context, string, models.TaskRelationType) ([]models.Task, error) {
	return nil, nil
}
...
func (s *apiStore) ReconcileExpiredBlockedTasks(context.Context, time.Time) ([]models.Task, error) {
	return nil, nil
}
...
func (s *apiStore) SpawnTieredContinuation(context.Context, string, []models.TieredContinuationTask) ([]models.Task, error) {
	return nil, nil
}

func (s *apiStore) RewireDependsOn(context.Context, string, string) ([]models.Task, error) {
	return nil, nil
}
