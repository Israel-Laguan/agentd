...
// against a shared httptest fixture.
func TestOpenAIWireContract(t *testing.T) {
	t.Parallel()

	t.Run("tools_request_shape", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("tool_call_id_round_trip", func(t *testing.T) {
		t.Parallel()
		srv := newWireContractServer(t, func(w http.ResponseWriter, r *http.Request) {
	...
	t.Run("error_status_mapping", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("json_mode_x_tools", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("embeddings_passthrough", func(t *testing.T) {
		t.Parallel()
		srv := newWireContractServer(t, func(w http.ResponseWriter, r *http.Request) {
