...
func TestMigrationSkipsWhenBlockedAlreadyInSchema(t *testing.T) {
...
func TestMigrationPreservesTasksAndAllowsBlockedState(t *testing.T) {
...
func TestMigrationAllowsFailedRequiresHumanState(t *testing.T) {
