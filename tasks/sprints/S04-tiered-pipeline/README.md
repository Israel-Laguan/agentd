...
| Status | **Closed — M3 fully shipped; M4/M5 primitives shipped but not wired to runtime (see [retro](retro/RETRO.md)); wiring carried to [S05](../S05-tiered-integration/README.md)** |
