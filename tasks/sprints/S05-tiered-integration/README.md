...
| --- | --- | --- | --- | --- |
| [T-020](tasks/T-020-tiered-verify-wiring-gap.md) | task | Wire escalation ladder into verify dispatch + fix metadata persistence + NEEDS_CONTEXT schema + real cost measurement | done | P1 |
