...
func (s *testStore) UpdateTaskPatch(_ context.Context, _ string, _ time.Time, state *models.TaskState, description *string) (*models.Task, error) {
	if state != nil {
		s.task.State = *state
	}
	if description != nil {
...
func (s *testStore) CompleteTieredOrigin(ctx context.Context, id string, ts time.Time, result models.TaskResult) (*models.Task, error) {
...
func (s *testStore) ListParentTasks(context.Context, string) ([]models.Task, error) {
	return nil, nil
}
...
func (s *testStore) ListChildTasksByRelation(context.Context, string, models.TaskRelationType) ([]models.Task, error) {
	return nil, nil
}
...
func (s *testStore) PersistTieredDAG(context.Context, string, time.Time, []models.TieredDAGTask) ([]models.Task, error) {
	return nil, nil
}

func (s *testStore) SpawnTieredContinuation(context.Context, string, []models.TieredContinuationTask) ([]models.Task, error) {
	return nil, nil
}

func (s *testStore) RewireDependsOn(context.Context, string, string) ([]models.Task, error) {
	return nil, nil
}
